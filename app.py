...
BASE_URL = os.getenv("BASE_URL")  # مثال: https://your-app.vercel.app
...
# في Vercel يتم تشغيل setup_webhook مرة واحدة عند بدء الحاوية
setup_webhook()

# هذا السطر ليس ضرورياً في Vercel لكنه مفيد للتشغيل المحلي
